export const animeCardData = [
  {
    ...
    images: {
      ...
      webp: { large_image_url: 'https://cdn.myanimelist.net/images/anime/4/19644.webp' },
    },
    trailer: { embed_url: 'https://www.youtube.com/embed/gY5nDXOtv_o?enablejsapi=1&wmode=opaque&autoplay=1' },
    synopsis:
